...
_efake_dict = {
    "2016" : {
        "BA" : "0.31*(abs(eta_2)<1.448)",
        "EC" : "0.22*(abs(eta_2)>1.558)"
    },
    "2017" : {
        "BA" : "0.26*(abs(eta_2)<1.448)",
        "EC" : "0.41*(abs(eta_2)>1.558)"
    },
    "2018" : {
        "BA" : "0.18*(abs(eta_2)<1.448)",
        "EC" : "0.30*(abs(eta_2)>1.558)"
    }
}

_mfake_dict = {
    "2016" : {
        "WH1" : "0.09*((abs(eta_2)<0.4))",
        "WH2" : "0.42*((abs(eta_2)>=0.4)*((abs(eta_2)<0.8)))",
        "WH3" : "0.20*((abs(eta_2)>=0.8)*((abs(eta_2)<1.2)))",
        "WH4" : "0.63*((abs(eta_2)>=1.2)*((abs(eta_2)<1.7)))",
        "WH5" : "0.17*((abs(eta_2)>=1.7))"
    },
    "2017" : {
        "WH1" : "0.18*((abs(eta_2)<0.4))",
        "WH2" : "0.32*((abs(eta_2)>=0.4)*((abs(eta_2)<0.8)))",
        "WH3" : "0.39*((abs(eta_2)>=0.8)*((abs(eta_2)<1.2)))",
        "WH4" : "0.42*((abs(eta_2)>=1.2)*((abs(eta_2)<1.7)))",
        "WH5" : "0.21*((abs(eta_2)>=1.7))"
    },
    "2018" : {
        "WH1" : "0.19*((abs(eta_2)<0.4))",
        "WH2" : "0.34*((abs(eta_2)>=0.4)*((abs(eta_2)<0.8)))",
        "WH3" : "0.24*((abs(eta_2)>=0.8)*((abs(eta_2)<1.2)))",
        "WH4" : "0.57*((abs(eta_2)>=1.2)*((abs(eta_2)<1.7)))",
        "WH5" : "0.20*((abs(eta_2)>=1.7))"
    }
}
...
qcd_variations_em = [
        ...
        ReplaceCutAndAddWeight("same_sign_CMS_htt_qcd_nonClosure_EraUp",   "os", Cut("q_1*q_2>0", "ss"), Weight("em_qcd_osss_binned_Weight*em_qcd_nonclosure_uncert_Weight", "qcd_weight")),
        ReplaceCutAndAddWeight("same_sign_CMS_htt_qcd_nonClosure_EraDown", "os", Cut("q_1*q_2>0", "ss"), Weight("em_qcd_osss_binned_Weight/em_qcd_nonclosure_uncert_Weight", "qcd_weight")),
        ]
